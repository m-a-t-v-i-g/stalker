...
GENERALMOVEMENT_API DECLARE_LOG_CATEGORY_EXTERN(LogGMCOnlineSubsystem, Log, All);
...
struct GENERALMOVEMENT_API FServerInfo
{
  GENERATED_BODY()
...
UCLASS()
class GENERALMOVEMENT_API USteamGameInstance : public UGameInstance
{
  GENERATED_BODY()
