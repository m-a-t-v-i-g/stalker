...
bool UGoldSrcConfigMenu::Initialize()
{
  if (Super::Initialize())
  {
    ...
    if (Button_UpdateArchetype) Button_UpdateArchetype->OnClicked.AddDynamic(this, &UGoldSrcConfigMenu::OnClicked_UpdateArchetype);
    ...
    if (Value_Acceleration) Value_Acceleration->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_Acceleration);
    if (Value_MaxSpeed) Value_MaxSpeed->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_MaxSpeed);
    if (Value_StopSpeed) Value_StopSpeed->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_StopSpeed);
    if (Value_SprintSpeed) Value_SprintSpeed->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_SprintSpeed);
    if (Value_CrouchWalkSpeed) Value_CrouchWalkSpeed->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_CrouchWalkSpeed);
    if (Value_CrouchInterpSpeed) Value_CrouchInterpSpeed->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_CrouchInterpSpeed);
    if (Value_CrouchedHalfHeight) Value_CrouchedHalfHeight->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_CrouchedHalfHeight);
    if (Value_FloorFriction) Value_FloorFriction->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_FloorFriction);
    if (Value_EdgeFrictionScale) Value_EdgeFrictionScale->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_EdgeFrictionScale);
    if (Value_EdgeFrictionMinRequiredHeight) Value_EdgeFrictionMinRequiredHeight->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_EdgeFrictionMinRequiredHeight);
    if (Value_bUseAltEdgeFriction) Value_bUseAltEdgeFriction->OnCheckStateChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnCheckStateChanged_bUseAltEdgeFriction);
    if (Value_JumpMode) Value_JumpMode->OnSelectionChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnSelectionChanged_JumpMode);
    if (Value_JumpForce) Value_JumpForce->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_JumpForce);
    if (Value_MaxGroundedVelocityZ) Value_MaxGroundedVelocityZ->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_MaxGroundedVelocityZ);
    if (Value_bApplyJumpSpeedBoost) Value_bApplyJumpSpeedBoost->OnCheckStateChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnCheckStateChanged_bApplyJumpSpeedBoost);
    if (Value_SmallJumpSpeedBoostFactor) Value_SmallJumpSpeedBoostFactor->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_SmallJumpSpeedBoostFactor);
    if (Value_LargeJumpSpeedBoostFactor) Value_LargeJumpSpeedBoostFactor->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_LargeJumpSpeedBoostFactor);
    if (Value_AirAcceleration) Value_AirAcceleration->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_AirAcceleration);
    if (Value_AirControl) Value_AirControl->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_AirControl);
    if (Value_WaterControl) Value_WaterControl->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_WaterControl);
    if (Value_SinkSpeed) Value_SinkSpeed->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_SinkSpeed);
    if (Value_WaterJumpForce) Value_WaterJumpForce->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_WaterJumpForce);
    if (Value_WaterJumpPush) Value_WaterJumpPush->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_WaterJumpPush);
    if (Value_bUseAltSwimControls) Value_bUseAltSwimControls->OnCheckStateChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnCheckStateChanged_bUseAltSwimControls);
    if (Value_SpeedHardCap) Value_SpeedHardCap->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_SpeedHardCap);
    if (Value_bConsiderMassOnJump) Value_bConsiderMassOnJump->OnCheckStateChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnCheckStateChanged_bConsiderMassOnJump);
    if (Value_GravityScale) Value_GravityScale->OnValueChanged.AddDynamic(this, &UGoldSrcConfigMenu::OnValueChanged_GravityScale);
...
void UGoldSrcConfigMenu::UpdateInterfaceValues() const
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
    ...
    if (Value_JumpMode) Value_JumpMode->SetSelectedOption(StaticEnum<EJumpMode>()->GetNameStringByValue(static_cast<int64>(GoldSrcMovementComponent->JumpMode)));
...
void UGoldSrcConfigMenu::UpdateArchetypeValues() const
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
    if (const auto Archetype = Cast<UGenGoldSrcMovementComponent>(GoldSrcMovementComponent->GetArchetype()))
    {
      ...
      if (Value_JumpMode) Archetype->JumpMode = static_cast<EJumpMode>(StaticEnum<EJumpMode>()->GetValueByNameString(Value_JumpMode->GetSelectedOption()));
...
UGenGoldSrcMovementComponent* UGoldSrcConfigMenu::GetLocalGoldSrcMovementComponent() const
{
  if (const auto World = GetWorld())
  {
    for (auto Iterator = World->GetPlayerControllerIterator(); Iterator; ++Iterator)
    {
      ...
      if (PlayerController && PlayerController->IsLocalController())
      {
        ...
        {
          return LocalPawn->FindComponentByClass<UGenGoldSrcMovementComponent>();
        }
        break;
      }
    }
...
void UGoldSrcConfigMenu::OnClicked_UpdateArchetype()
{
  UpdateArchetypeValues();
}

void UGoldSrcConfigMenu::OnValueChanged_Acceleration(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_MaxSpeed(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_StopSpeed(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_SprintSpeed(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_CrouchWalkSpeed(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_CrouchInterpSpeed(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_CrouchedHalfHeight(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_FloorFriction(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_EdgeFrictionScale(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_EdgeFrictionMinRequiredHeight(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnCheckStateChanged_bUseAltEdgeFriction(bool bIsChecked)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnSelectionChanged_JumpMode(FString SelectedItem, ESelectInfo::Type SelectionType)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
    const int64 JumpModeIndex = StaticEnum<EJumpMode>()->GetValueByNameString(SelectedItem);
    if (JumpModeIndex != INDEX_NONE)
    {
      GoldSrcMovementComponent->JumpMode = static_cast<EJumpMode>(JumpModeIndex);
      return;
    }
  }
}

void UGoldSrcConfigMenu::OnValueChanged_JumpForce(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_MaxGroundedVelocityZ(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnCheckStateChanged_bApplyJumpSpeedBoost(bool bIsChecked)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_SmallJumpSpeedBoostFactor(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_LargeJumpSpeedBoostFactor(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_AirAcceleration(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_AirControl(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_WaterControl(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_SinkSpeed(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_WaterJumpForce(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_WaterJumpPush(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnCheckStateChanged_bUseAltSwimControls(bool bIsChecked)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_SpeedHardCap(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnCheckStateChanged_bConsiderMassOnJump(bool bIsChecked)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
...
void UGoldSrcConfigMenu::OnValueChanged_GravityScale(float InValue)
{
  if (const auto GoldSrcMovementComponent = GetLocalGoldSrcMovementComponent())
  {
