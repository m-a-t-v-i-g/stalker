...
void AGenPawn::PossessedBy(AController* NewController)
{
  Super::PossessedBy(NewController);

  checkGMC(GetLocalRole() == ROLE_Authority)
  // We always need a full net serialization update in this case because the net role of the client pawn may change. This is especially
  // important with regard to @see UGenMovementReplicationComponent::Client_LastReceivedServerState.
  Server_bNeedsFullNetSerializationOnNextUpdate = true;
}

void AGenPawn::UnPossessed()
{
  Super::UnPossessed();
