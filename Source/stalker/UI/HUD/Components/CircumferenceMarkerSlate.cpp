...
SCircumferenceMarkerSlate::SCircumferenceMarkerSlate()
{
}

void SCircumferenceMarkerSlate::Construct(const FArguments& InArgs)
{
...
int32 SCircumferenceMarkerSlate::OnPaint(const FPaintArgs& Args, const FGeometry& AllottedGeometry,
...
FVector2D SCircumferenceMarkerSlate::ComputeDesiredSize(float) const
{
	check(MarkerBrush);
...
void SCircumferenceMarkerSlate::SetRadius(float NewRadius)
{
...
void SCircumferenceMarkerSlate::SetMarkerList(TArray<FCircumferenceMarkerEntry>& NewMarkerList)
{
	MarkerList = NewMarkerList;
}

FSlateRenderTransform SCircumferenceMarkerSlate::GetMarkerRenderTransform(const FCircumferenceMarkerEntry& Marker,
