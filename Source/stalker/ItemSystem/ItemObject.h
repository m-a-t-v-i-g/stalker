...
public:
	...
	UPROPERTY(EditAnywhere, DisplayName = "Actor Class", Category = "Class")
	TSubclassOf<class AItemActor> ItemActorClass;

	UPROPERTY(EditAnywhere, DisplayName = "Instance Class", Category = "Class")
	TSubclassOf<class UItemInstance> ItemInstanceClass;

	UPROPERTY(EditAnywhere, DisplayName = "Object Class", Category = "Class")
