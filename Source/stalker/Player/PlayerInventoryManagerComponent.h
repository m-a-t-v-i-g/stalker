...
#include "PlayerInventoryManagerComponent.generated.h"
...
UCLASS()
class STALKER_API UPlayerInventoryManagerComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	UPlayerInventoryManagerComponent();
